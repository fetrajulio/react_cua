...
class HomePage extends React.Component<IDashboardProps, IPageState> {
    ...
    private renderUsers(): JSX.Element {
        ...
        return (
            <Paper className={classNames(classes.paper, classes.users)}>
                <h3 className={classes.sectionTitle}>Fanambadiana(Mariage)</h3>
    ...
    private renderRadialBarChart(): JSX.Element {
        return (
            <Paper className={this.props.classes.paper}>
                <h3 className={this.props.classes.sectionTitle}>Hetra 2020--2021</h3>
    ...
    private renderBarChart(): JSX.Element {
        return (
            <Paper className={this.props.classes.paper}>
                <h3 className={this.props.classes.sectionTitle}>PIB D'Antanarivo 2020-2021</h3>
                <ResponsiveContainer width="100%" height={300}>
                ...
                <Grid container={true} spacing={24}>
                    <Grid item={true} lg={3} xs={12} sm={6}>
                        <Paper className={classNames(classes.paper, classes.headerTiles)}>
                            ...
                            <Typography className={classes.tileText}> {this.props.users.items.length} 3 Fanambadiana</Typography>
                        </Paper>
                    </Grid>
                    <Grid item={true} lg={3} xs={12} sm={6}>
                        <Paper className={classNames(classes.paper, classes.headerTiles)}>
                            <MailIcon className={classes.headerTileIcon} />
                            <Typography className={classes.tileText}> 11 Positra</Typography>
                        </Paper>
                    </Grid>
                    <Grid item={true} lg={3} xs={12} sm={6}>
                        <Paper className={classNames(classes.paper, classes.headerTiles)}>
                            <BusinessIcon className={classes.headerTileIcon} />
                            <Typography className={classes.tileText}>10.000 ar Hetra</Typography>
                        </Paper>
                    </Grid>
                    <Grid item={true} lg={3} xs={12} sm={6}>
                        <Paper className={classNames(classes.paper, classes.headerTiles)}>
                            <SettingsIcon className={classes.headerTileIcon} />
                            <Typography className={classes.tileText}>Configuration</Typography>
                        </Paper>
                    </Grid>
